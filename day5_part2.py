...
for i in data[10:]:
    ...
    From_i = int(i[3])
    To_i = int(i[5])
    removed = containers[From_i - 1][0:Amount_i]
    containers[From_i - 1][0:Amount_i] = []
    containers[To_i -1] = removed + containers[To_i - 1]
...
if __name__ == '__main__':                                                             
    submit(first_on_stack, part = 2, day = 5, year = 2022)
